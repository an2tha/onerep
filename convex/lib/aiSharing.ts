...
export const AI_SHARING_VERSION = 3;
export const AI_SHARING_RECIPIENTS =
  "TypeSafe AI (Jev), which prepares the Coach interface from your message and recent conversation, and OpenRouter, which sends requests to Microsoft Azure (hosting the Default OpenAI model) or Venice (Uncensored model).";
