...
export const exportMyData = query({
  ...
  handler: async (ctx) => {
    ...
    const [
      ...
      ctx.db.query("userPreferences").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("recipes").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("onboardingProfiles").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("healthProfiles").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("presets").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("schedules").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("workoutLogs").withIndex("by_userId_date", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("foodLogs").withIndex("by_userId_date", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("waterLogs").withIndex("by_userId_date", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("bodyMeasurements").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("dailyCheckIns").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("activeWorkouts").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
      ctx.db.query("exercises").withIndex("by_userId", (q) => q.eq("userId", user._id)).take(1000),
    ]);
