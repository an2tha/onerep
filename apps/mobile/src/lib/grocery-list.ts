...
const CATEGORY_KEYWORDS: [string, string[]][] = [
  [
    ...
    ["apple", "banana", "spinach", "kale", "lettuce", "tomato", "onion",
      "garlic", "carrot", "pepper", "broccoli", "cucumber", "potato", "lemon",
      "lime", "berry", "avocado", "mushroom", "celery", "herb", "basil",
      "cilantro", "parsley", "ginger", "zucchini", "courgette"],
  ],
  [
    "Protein",
    ["chicken", "beef", "pork", "turkey", "salmon", "tuna", "shrimp", "prawn",
      "fish", "egg", "tofu", "tempeh", "lamb", "bacon", "sausage", "mince",
      "steak", "lentil", "chickpea", "bean"],
  ],
  [
    "Dairy",
  ...
  [
    "Frozen",
    ["frozen", "ice cream", "pea"],
  ],
  [
    "Pantry",
    ["rice", "pasta", "flour", "sugar", "oil", "vinegar", "salt", "pepper",
      "spice", "sauce", "stock", "broth", "oat", "quinoa", "noodle", "bread",
      "honey", "syrup", "nut", "almond", "peanut", "seed", "cocoa", "tortilla",
      "cereal", "couscous"],
  ],
]
...
export function mergeGroceryItems(items: GroceryItem[]): GroceryItem[] {
  ...
  for (const item of items) {
    ...
    const target = merged.find((candidate) => {
      ...
      if (candidate.grams !== undefined || item.grams !== undefined) return false
      return (
